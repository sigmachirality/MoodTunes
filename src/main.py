...
def get_token(request):
    ...
    token = requests.post('https://accounts.spotify.com/api/token', data={'grant_type': 'authorization_code', 'code': auth_code, 'redirect_uri': 'https://moodtunes-220104.appspot.com/recommend', 'client_id': sp.client_id, 'client_secret': sp.client_secret})
